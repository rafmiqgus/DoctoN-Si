    ...
    return (
      <>
        <div className="Sommaire-binaire">
          <div className={`hover-area-binaire-container ${isHovered ? "no-style-binaire" : ""}`}>
            <div
              className={`hover-area-binaire ${isHovered ? "no-style-binaire" : ""}`}
              onMouseEnter={handleMouseEnter}
              onMouseLeave={handleMouseLeave}
            >
              <div
                className={`dots-binaire ${isHovered ? "display-none-binaire" : ""}`}
              >
                <embed
                  src={dots}
                  id="Dots-svg"
        ...
        <div className={`Binaire ${isHovered ? "blurred-binaire" : ""}`}>
          ...
          <p>
            ...
            <h3>
              ...
              7 x10<sup>0</sup>
              <br />
              &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;*(on
              rappelle que 10<sup>0</sup> = 1)
              <br />
              <br />
            </h3>
            <p>
            ...
            <br/>
            <h3>1. Comprendre les rangs et les puissances de deux</h3>
            <p>
            ...
            <br/>
            <h3>2. Calculer la valeur décimale de chaque bit</h3>
            <p>
            ...
            <br/>
            <h3>3. Faire la somme des valeurs obtenues</h3>
            <p>Ajoutez toutes les valeurs calculées ensemble :</p>
            <p>
            ...
            <div id="section5" className="section"></div>
            <h1>L’hexadécimal</h1>
            <h3>Pourquoi Utiliser l'Hexadécimal en Informatique</h3>
            <p>
            ...
            <div id="section6" className="section"></div>
            <h3>Conversion entre Hexadécimal et Binaire</h3>
            <p>
            ...
            <div id="section7" className="section"></div>
            ...
            <div id="section8" className="section"></div>
            <h2>Conversion d'une Base quelconque en Décimal</h2>
            <p>
            ...
            <div id="section9" className="section"></div>
            ...
            <p>On utilise les puissances de ( b ) pour chaque chiffre :</p>
            <pre>
