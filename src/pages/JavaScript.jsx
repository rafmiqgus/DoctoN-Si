...
function JavaScript() {
  ...
  return (
    <>
      <div className="Sommaire-JS">
        <div
          className={`hover-area-JS ${isHovered ? "no-style-JS" : ""}`}
          onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave}
        >
          <div className={`dots-JS ${isHovered ? "display-none-JS" : ""}`}>
            <embed
              src={dots}
              id="Dots-svg"
              width="20px"
          ...
          {isHovered && (
            <div className="hover-bar-container-JS">
              <div className="hover-bar-JS">
                <button
                  className="bar-button-JS"
      ...
      <div className={`JavaScript ${isHovered ? "blurred-JS" : ""}`}>
        <div id="variables" className="section"></div>
        <h3>Les variables</h3>
        <p>
          ...
          <br />
          <h2>Déclaration et affectation</h2>
          <table>
            <thead>
              <tr>
          ...
          <div id="listes" className="section"></div>
          <h3>Les listes</h3>
          <table>
            <thead>
              <tr>
          ...
          <br />
          <div id="objets" className="section"></div>
          <h3>Les objets</h3>
          <p>
          ...
          <div id="boucles-et-conditions" className="section"></div>
